...
## 1. can get AIC for a regular HMM model with one seed and one state 
## 2. can get min AIC for a regular HMM model with a number of seeds (NUM_OF_SEED) for one state
## 3. can get min AIC for a regular HMM model with a number of seeds (NUM_OF_SEED) across states
Get_minAIC_RegHMM_for_one_seed = function(mydata, condition_to_use, row_to_use, num_states, seed_value) {
    set.seed(seed_value)
    ...
    result = c(condition_to_use, num_states, seed_value, AIC(RegHMM_fit))
    names(result) = c("condition_to_use", "num_states", "seed_value", "AIC")
    return (result)
}

NUM_OF_SEED = 20
Get_minAIC_RegHMM_for_one_state = function(mydata, condition_to_use, row_to_use, num_states) {
    ...
    for (i in 1:num_of_seed) {
        ...
        tryCatch(
            {
                result = Get_minAIC_RegHMM_for_one_seed(mydata, condition_to_use, row_to_use, num_states, current_seed)
...
Get_minAIC_RegHMM_for_multi_states = function(mydata, condition_to_use, row_to_use){
    ...
    current_min_AIC = Get_minAIC_RegHMM_for_one_state(mydata, condition_to_use, row_to_use, current_num_states)
    found_min = FALSE
    ...
    while (found_min == FALSE) {
        ...
        next_min_AIC = Get_minAIC_RegHMM_for_one_state(mydata, condition_to_use, row_to_use, current_num_states)
...
# # check the functions
# #
# result_one_seed = Get_minAIC_RegHMM_for_one_seed(GenData_NoSeason_2cp, condition_to_use=1, row_to_use=4, num_states=2, seed_value=1234)
# result_one_seed
# #
# result_one_state = Get_minAIC_RegHMM_for_one_state(GenData_NoSeason_2cp, condition_to_use=1, row_to_use=4, num_states=2)
# result_one_state
# # 
# res_across_states = Get_minAIC_RegHMM_for_multi_states(GenData_NoSeason_2cp, condition_to_use=1, row_to_use=4)
# res_across_states
